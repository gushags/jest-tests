...
test("return an object", () => {
  expect(analyzeArray([2, 3, 4])).toEqual(expect.any(Object));
});

test("return average", () => {
  expect(analyzeArray([2, 3, 4]).average).toBe(3);
});

test("return minimum value", () => {
  expect(analyzeArray([1, 2, 3, 4, 0, -4]).min).toBe(-4);
});

test("return maximum value", () => {
  expect(analyzeArray([1, 2, 15, 4]).max).toBe(15);
});

test("return length", () => {
  expect(analyzeArray([1, 2, 15, 4]).length).toBe(4);
});
